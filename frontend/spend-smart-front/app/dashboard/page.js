...
function Dashboard() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-[#4169E1] p-4 mt-16"> {/* Added mt-16 to account for fixed navbar height */}
        {/* Sidebar content can remain unchanged */}
        <div className="text-white mb-4">Add Expense</div>
        <div className="text-white mb-4">Update Expense</div>
        <div className="text-white mb-4">Remove Expense</div>
        <div className="text-white mb-4">Filter Expense</div>
        <div className="text-white mb-4">Logout</div>
      </aside>

      <div className="flex-1 p-6 mt-16"> {/* Added mt-16 to account for fixed navbar height */}
        <div className="flex justify-center" style={{ marginLeft: '96px', marginRight: '96px' }}>
          <WineDisplay />
        </div>
        <br />
